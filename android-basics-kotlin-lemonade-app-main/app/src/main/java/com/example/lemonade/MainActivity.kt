...
//        // above when block can be replaced by the following if-else block
...
//        }
    ...
    private fun setViewElements() {
        ...
        // variables to set text and image resources
        var drawableResource = R.drawable.lemon_tree
        var stringResource = getString(R.string.lemon_select)

        drawableResource = when (lemonadeState) {
        ...
        stringResource = when(lemonadeState){
        ...
        // actually setting text and image resources
